...
export function WatchlistLogo({ size = 40 }) {
  return (
    <svg className="watchlist-logo" width={size} height={size} viewBox="0 0 40 40" aria-hidden="true">
      <circle cx="14" cy="16" r="10" style={{ fill: 'var(--watch-terracota)' }} opacity="0.85" />
      <circle cx="26" cy="16" r="10" style={{ fill: 'var(--watch-petroleo)' }} opacity="0.85" />
      <circle cx="20" cy="25" r="10" style={{ fill: 'var(--watch-rosa)' }} opacity="0.85" />
      <path
